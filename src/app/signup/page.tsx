...
import { Mail, Lock, User, Radio, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="min-h-screen flex items-center justify-center py-12 px-4">
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-black text-white uppercase mb-2">Join Newtown Radio</h1>
                    <p className="text-neutral-400">Create your account and start listening</p>
                </div>
                ...
                <div className="bg-neutral-900 border border-white/10 rounded-2xl p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="text-sm">
                            <label className="flex items-start gap-2 cursor-pointer">
                                <input type="checkbox" required className="w-4 h-4 mt-0.5 accent-brand-lemon" />
                                <span className="text-neutral-400">
                                    I agree to the{' '}
                                    <a href="/terms" className="text-brand-lemon hover:underline">Terms of Service</a>
                                    {' '}and{' '}
                                    <a href="/privacy" className="text-brand-lemon hover:underline">Privacy Policy</a>
                                </span>
                            </label>
                        </div>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-neutral-400 text-sm">
                            ...
                            <Link href="/login" className="text-brand-lemon font-bold hover:underline">
                                Sign In
                            </Link>
                        </p>
                    </div>
                ...
                <div className="mt-6">
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-brand-gray text-neutral-500 uppercase font-bold">Or sign up with</span>
                        </div>
                    </div>
